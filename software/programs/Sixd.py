...
Sin = [0, 1, 2, 4, 5, 7, 8, 9, 11, 12, 14, 15, 16,
...
while True:
    ...
    Knob2 = k2.read_position(100)
    Knob1 = k1.read_position(100)/1000
    cv1.voltage((Sin[step1]+116)*Knob2/2500)
    cv2.voltage((Sin[step2]+116)*Knob2/2500)
    cv3.voltage((Sin[step3]+116)*Knob2/2500)
    cv4.voltage((Sin[step4]+116)*Knob2/2500)
    cv5.voltage((Sin[step5]+116)*Knob2/2500)
    cv6.voltage((Sin[step6]+116)*Knob2/2500)
    step1 = step1 + 1
